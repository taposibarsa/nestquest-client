...
/** Full-page redirect to backend Google OAuth (not a fetch). */
export function GoogleSignInButton({
  ...
  async function onClick() {
    ...
    const statusUrl = url.replace(/\/google\/?$/, "/google/status");
    ...
    try {
      ...
      // Server unreachable — still attempt redirect so the user sees the failure
    }
